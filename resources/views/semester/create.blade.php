           ...
           <div class="tile-body col-md-6">
             <form method="post" action="{{route('semester.store')}}">
               ...
               <div class="form-group">
                 ...
                 <input name="name" class="form-control" type="text" placeholder="Enter semester name">
               </div>
               ...
               <div class="form-group">
                 ...
                 <input name="examDate" class="form-control" type="text" placeholder="Enter exam date">
               </div>
